...
export default function CareersPage() {
  ...
  return (
    <main ref={pageRef} className="mk-light-page min-h-screen" data-interactive>
      ...
      >
        <p className="mk-reveal mb-4 font-sans text-[0.75rem] uppercase tracking-[0.2em] text-[var(--gold)]">
          Join the Studio
        </p>
      ...
      >
        <div className="mx-auto max-w-4xl">
          <p className="mk-reveal font-sans text-[0.75rem] uppercase tracking-[0.2em] text-[var(--gold)]">
            Why Us
          </p>
          <h2 className="mk-reveal mk-reveal-d1 mt-3 font-serif text-[clamp(2rem,5vw,3.5rem)] font-medium leading-tight">
            Design With Purpose
          </h2>
          <ul className="mk-reveal mk-reveal-d2 mt-8 grid gap-4 font-sans text-base leading-relaxed text-[var(--text-dark-soft)] sm:grid-cols-2">
            {[
          ...
          {submitStatus !== "success" ? (
            ...
            >
              <fieldset className="flex flex-col gap-4">
                <legend className="mb-1 font-sans text-[0.7rem] uppercase tracking-[0.18em] text-[var(--text-dark-muted)]">
                  Basic Information
                </legend>
              ...
              <fieldset className="flex flex-col gap-4">
                ...
                <p className="font-sans text-xs italic text-[var(--text-dark-soft)]">
                  Tip: Right-click your file in Google Drive, choose Share, copy the link, and paste it here.
                </p>
              </fieldset>
            ...
            >
              <div className="mk-thankyou-card">
                ...
                <p className="text-center font-sans text-sm text-[var(--text-dark-soft)]">
