        ...
        <div className="mx-auto max-w-2xl">
          ...
          >
            ...
            <fieldset className="flex flex-col gap-4">
              ...
              <input className="mk-careers-input" type="text" placeholder="Full Name" required data-cursor-ignore />
              <input className="mk-careers-input" type="email" placeholder="Email Address" required data-cursor-ignore />
              <input className="mk-careers-input" type="tel" placeholder="Phone Number" required data-cursor-ignore />
              <input className="mk-careers-input" type="text" placeholder="Current City" required data-cursor-ignore />
            </fieldset>
            ...
            <fieldset className="flex flex-col gap-4">
              ...
              <select className="mk-careers-input" defaultValue="" data-cursor-ignore>
            ...
            <fieldset className="flex flex-col gap-4">
              ...
              <input className="mk-careers-input" type="text" placeholder="Highest Qualification" data-cursor-ignore />
              <input className="mk-careers-input" type="text" placeholder="Current Organisation / Institute" data-cursor-ignore />
              <input className="mk-careers-input" type="url" placeholder="Portfolio Link (URL)" data-cursor-ignore />
            </fieldset>
            ...
            <fieldset className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <label className="font-sans text-xs text-[var(--text-dark-soft)]">Resume (PDF only)</label>
                <input className="mk-careers-input" type="file" accept=".pdf" data-cursor-ignore />
              </div>
              <div className="flex flex-col gap-1">
                <label className="font-sans text-xs text-[var(--text-dark-soft)]">Portfolio (PDF)</label>
                <input className="mk-careers-input" type="file" accept=".pdf" data-cursor-ignore />
              </div>
              <div className="flex flex-col gap-1">
                <label className="font-sans text-xs text-[var(--text-dark-soft)]">Additional Work Samples / 3D Files (optional)</label>
                <input className="mk-careers-input" type="file" data-cursor-ignore />
              </div>
            </fieldset>

            <div className="pt-2 text-center">
              <button type="submit" className="mk-careers-btn font-sans" data-interactive>
                Submit Application
              </button>
            </div>
          </form>
