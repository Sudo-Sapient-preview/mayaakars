                ...
                <section className="arch-layout">
                    <div className="arch-steps-list">
                        {service.images.slice(1).map((img, index) => (
                            <div key={img.src} className="arch-step-item">
                                <div className="arch-step-meta">
                                    <span className="arch-step-num">{String(index + 1).padStart(2, "0")}</span>
                                    <span className="arch-step-name">{img.title}</span>
                                </div>
                                <div
                                    className={`arch-step-img-wrap${index === 0 ? " arch-step-img-wrap--portrait" : ""}`}
                                >
                                    <Image
                                        src={img.src}
                                        alt={img.title}
